...
export const languageDictionary: LanguageDictionaryType = {
  ...
  es: {
    additionalOrderDetailsLabel: "Detalles adicionales del pedido",
    editLabel: "Editar",
    pleaseWaitLabel: "Espere por favor...",
    saveContinueLabel: "Guardar Continuar",
    spotLeftLabel: "punto izquierdo",
    customerInfoLabel: "Información del cliente",
    soldOutLabel: "Vendido",
    spotsLeftLabel: "lugares a la izquierda",
    whoopsLabel: "¡Ups!",
  ...
  ja: {
    additionalOrderDetailsLabel: "追加注文の詳細",
    editLabel: "編集",
    pleaseWaitLabel: "お待ちください...",
    saveContinueLabel: "保存して続行",
    spotLeftLabel: "左のスポット",
    customerInfoLabel: "お客様情報",
    soldOutLabel: "完売",
    spotsLeftLabel: "残ったスポット",
    whoopsLabel: "うわぁぁぁぁぁぁぁぁぁぁぁぁぁあ!!",
  ...
  ger: {
    additionalOrderDetailsLabel: "Zusätzliche Bestelldetails",
    editLabel: "Bearbeiten",
    pleaseWaitLabel: "Warten Sie mal...",
    saveContinueLabel: "Speichern fortsetzen",
    spotLeftLabel: "Platz links",
    customerInfoLabel: "Kundeninformation",
    soldOutLabel: "Ausverkauft",
    spotsLeftLabel: "flecken übrig",
    whoopsLabel: "Hoppla!",
  ...
  swe: {
    additionalOrderDetailsLabel: "Ytterligare orderinformation",
    editLabel: "Redigera",
    pleaseWaitLabel: "Vänta...",
    saveContinueLabel: "Spara och fortsätt",
    spotLeftLabel: "plats kvar",
    customerInfoLabel: "Kundinformation",
    soldOutLabel: "Utsåld",
    spotsLeftLabel: "platser kvar",
    whoopsLabel: "Oj då!",
  ...
  fr: {
    additionalOrderDetailsLabel: "Détails de la commande supplémentaires",
    editLabel: "Éditer",
    pleaseWaitLabel: "S'il vous plaît, attendez...",
    saveContinueLabel: "Enregistrer continuer",
    spotLeftLabel: "place à gauche",
    customerInfoLabel: "Informations concernant le client",
    soldOutLabel: "Épuisé",
    spotsLeftLabel: "il reste des places",
    whoopsLabel: "Oups !",
  ...
  nl: {
    additionalOrderDetailsLabel: "Aanvullende bestelgegevens",
    editLabel: "Bewerk",
    pleaseWaitLabel: "Wacht alsjeblieft...",
    saveContinueLabel: "Opslaan doorgaan",
    spotLeftLabel: "plek links",
    customerInfoLabel: "Klant info",
    soldOutLabel: "Uitverkocht",
    spotsLeftLabel: "plekjes over",
    whoopsLabel: "Oeps!",
  ...
  it: {
    additionalOrderDetailsLabel: "Ulteriori dettagli sull'ordine",
    editLabel: "modificare",
    pleaseWaitLabel: "Attendere prego...",
    saveContinueLabel: "Salva e continua",
    spotLeftLabel: "posto lasciato",
    customerInfoLabel: "Informazioni sul cliente",
    soldOutLabel: "Esaurito",
    spotsLeftLabel: "posti rimasti",
    whoopsLabel: "Ops!",
