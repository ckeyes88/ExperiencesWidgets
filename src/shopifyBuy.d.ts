/**
 * NOTE: Taken from Definitely Typed typings for JS Buy SDK (Shopify Buy). We cannot use the
 * @types/shopify-buy lib as normal as it seems to incorrectly type some methods. For example,
 * the checkout `addLineItems` method should not require `LineItem[]` as defined in the typings
 * file, but rather adhere to the input as defined here: 
 * 
 * - https://help.shopify.com/en/api/storefront-api/reference/mutation/input-object/checkoutlineiteminput
 ...
 * 
 *  Please see this issue for more information: https://github.com/Shopify/js-buy-sdk/issues/504
 */
